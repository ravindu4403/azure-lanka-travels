...
export const metadata = {
  ...
  alternates: { canonical: '/accommodation-request' },
};

export default async function AccommodationRequestPage() {
  const settings = await getSiteSettings();
  return (
    <>
      <Header />
      <main className="public-subpage accommodation-page">
        <section className="section figma-page accommodation-hero">
          <span className="small-label left-label">Accommodation Assistance</span>
          <h1>Stay Near Yala With Trusted Local Help</h1>
          <p>Send your dates, budget and room preference. Our team will manually check suitable hotel options around Yala, Tissamaharama and Kataragama and contact you with recommendations.</p>
          <div className="accommodation-feature-grid">
            <article><strong>Not a hotel engine</strong><span>We collect your request and assist manually.</span></article>
            <article><strong>Safari-friendly stays</strong><span>Easy pickup planning for morning and full-day safaris.</span></article>
            <article><strong>Tourist support</strong><span>WhatsApp guidance for foreign travelers.</span></article>
          </div>
        </section>
        <section className="section figma-page accommodation-request-section">
          <div className="booking-copy"><span className="small-label left-label">Request Form</span><h2>Tell Us What Kind Of Stay You Need</h2><p>After submitting, the request appears in the admin panel. Admin can mark it as Searching Hotels, Options Sent, Closed or Cancelled.</p></div>
